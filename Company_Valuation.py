...
stocks = np.array(['AAPL','AMZN','MSFT','TSLA','GOOG','FB','IBM','STM',
                   'NXPI','TXN','MCHP','BLDP','NUAN','TWLO','APO','SNE',
                   'LOGI','MRVL','QCOM','BBY','CRM','NVDA','MA','IDXX',
                   'MASI','SGEN','GLPG','MTLS','DXCM','BEP','NEE','ENPH',
                   'PLUG','ITM.L','AFC.L','ABB','AMD','TUI.L','SQ','CHE','ARLO'])
